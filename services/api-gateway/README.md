...
REST and GraphQL edge, RBAC enforcement point, per ARCHITECTURE.md section 22
...
**Local dev:** `cd services/api-gateway && poetry install && poetry run uvicorn app.main:app --reload`
