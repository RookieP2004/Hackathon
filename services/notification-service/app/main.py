...
TAGS_METADATA = [
    ...
    {"name": "alerts", "description": "Alert lifecycle (raise/acknowledge/resolve) — DATABASE_SCHEMA.md §11, ARCHITECTURE.md §11.3."},
]
...
def create_app() -> FastAPI:
    ...
    """
    application = FastAPI(
        title="AEGIS AI — Notification Service",
        description="Multi-channel alert escalation delivery (ARCHITECTURE.md §11.3).",
        version="0.1.0",
